...
# Incorporate data
df = pd.read_csv('IN.csv', parse_dates=['snapshot_date'])
...
layout = html.Div([
    ...
    dbc.Container([
        dbc.Row(
        [
            dbc.Col(html.Img(src="/assets/in.png", height="50px"), width="auto"),
            dbc.Col(html.H5([
    ...
    html.Div([
        html.Div([
            ...
            dcc.RangeSlider(id='in_range_slider', min=0, max=days,
        ...
        html.Div([
            ...
            dcc.Dropdown(id='in_artists_dropdown',
...
@app.callback(
    [Output('in_popular_songs', 'figure'),
     Output('in_popular_artists', 'figure')] ,
    Input('in_explicit-selector', 'value')
)
...
# Define callback to update graph
@app.callback(
    Output('in_popularity_changing', 'figure'),
    [Input('in_range_slider', 'value'),
     Input('in_artists_dropdown', 'value')]    
)
