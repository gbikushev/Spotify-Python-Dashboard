...
layout = html.Div([
    ...
    dbc.Container([
        dbc.Row(
        [
            dbc.Col(html.Img(src="/assets/us.png", height="50px"), width="auto"),
            dbc.Col(html.H5([
    ...
    html.Div([
        html.Div([
            ...
            dcc.RangeSlider(id='us_range_slider', min=0, max=days,
        ...
        html.Div([
            ...
            dcc.Dropdown(id='us_artists_dropdown',
...
@app.callback(
    [Output('us_popular_songs', 'figure'),
     Output('us_popular_artists', 'figure')] ,
    Input('us_explicit-selector', 'value')
)
...
# Define callback to update graph
@app.callback(
    Output('us_popularity_changing', 'figure'),
    [Input('us_range_slider', 'value'),
     Input('us_artists_dropdown', 'value')]    
)
